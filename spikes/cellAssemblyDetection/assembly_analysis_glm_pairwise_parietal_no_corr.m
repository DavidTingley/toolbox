...
% list = list(3:end);
load('/media/nitzlab/data/Dropbox/Dropbox/w_parietal.mat','w_parietal');
...
for recording = 1:99
       ...
       if e ~= 0
           mkdir(['/media/nitzlab/Iomega HDD/David/assemblies_parietal/' rats(rat,:) '/' sprintf('%02.0f',recording)])
       ...
       parfor win = 0:600
       if ~exist(['/media/nitzlab/Iomega HDD/David/assemblies_parietal/' rats(rat,:) '/' sprintf('%02.0f',recording)  '/'...
...
%     % HMM, linear regression, GLM  
    ...
    load(['/media/nitzlab/Iomega HDD/David/recording_trains_pairwise_parietal/' rats(rat,:) '/' sprintf('%02.0f',recording)  '/'...
           rats(rat,:) '_rec_' sprintf('%02.0f',recording) '_winsize_'  num2str(win) '.mat'],...
...
if ~isempty(cell_list)
        ...
        save(['/media/nitzlab/Iomega HDD/David/assemblies_parietal/' rats(rat,:) '/' sprintf('%02.0f',recording)  '/'...
           rats(rat,:) '_rec_' sprintf('%02.0f',recording) '_winsize_'  num2str(win) '.mat'],...
