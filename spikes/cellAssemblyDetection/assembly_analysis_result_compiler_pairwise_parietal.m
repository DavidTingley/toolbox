...
for rat = 1:8
   for rec = 1:99 
       ...
       if exist(['/media/nitzlab/Iomega HDD/David/assemblies_parietal/' rats(rat,:) '/' sprintf('%02.0f',rec) ])
        e = dir(['/media/nitzlab/Iomega HDD/David/assemblies_parietal/' rats(rat,:) '/' sprintf('%02.0f',rec) '/'...
...
save assembly_population_results_parietal_no_corr
 end
...
function   [dev_new dev_justpeers_new dev_justpos_new dev_control_new ind val indc valc cell_list]...
    ...
    for win = 1:601
      ...
      load(['/media/nitzlab/Iomega HDD/David/assemblies_parietal/' rats(rat,:) '/' sprintf('%02.0f',rec) '/'...
...
if length(unique(wire))>1
      ...
      save(['/media/nitzlab/data/Dropbox/Dropbox/results_parietal/'...
