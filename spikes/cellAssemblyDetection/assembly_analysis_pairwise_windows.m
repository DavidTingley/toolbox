...
sigs = 'C:\Users\Nitz Lab 2\Dropbox_tingley\Dropbox\Spike_trains\';

% load('C:\Users\Nitz Lab 2\Dropbox_tingley\Dropbox\Dropbox\num_cells.mat')
load('C:\Users\Nitz Lab 2\Dropbox_tingley\Dropbox\num_cells')
ncells = num_cells;
rec_start = 109;
...
clear  success_trains spiral* tt s_all*
    ...
    mkdir(['C:\Users\Nitz Lab 2\Dropbox_tingley\Dropbox\recording_trains_pairwise/' ratname ...
        '/' num2str(recording)])
    
    parfor i = 0:600 % ms window
         [s_all s_all_norm] = paradd_pairwise(ncells,rec,i,s);
          fsave(['C:\Users\Nitz Lab 2\Dropbox_tingley\Dropbox\recording_trains_pairwise\' ...
