...
% list = dir('\\media\nitzlab\Iomega HDD\David\recording_trains_pairwise\');
% list = list(3:end);
load('C:\Users\Nitz Lab 2\Dropbox_tingley\Dropbox\w_parietal.mat','w_parietal');
w = w_parietal; clear w_parietal;
load('C:\Users\Nitz Lab 2\Dropbox_tingley\Dropbox\spike_overlap_percentages_within_3ms_parietal.mat','list_percentages');

%% should run once to do all glm analyses
rats = ['AA8';'DN3';'NS1'; 'NS2';'NS3';'NS4';'NS5';'NS8'];
load('C:\Users\Nitz Lab 2\Dropbox_tingley\Dropbox\parietal_dataset.mat','file','num_cells');
ncells = num_cells;

for rat = [8:-1:1]
for recording = 99:-1:1

       e = exist(['C:\Users\Nitz Lab 2\Dropbox_tingley\Dropbox\recording_trains_pairwise_parietal\' rats(rat,:) '\' sprintf('%02.0f',recording)  '\'...
       ...
       if e ~= 0
           mkdir(['C:\Users\Nitz Lab 2\Dropbox_tingley\Dropbox\assemblies_parietal\' rats(rat,:) '\' sprintf('%02.0f',recording)])
       ...
       parfor win = 0:600
       if ~exist(['C:\Users\Nitz Lab 2\Dropbox_tingley\Dropbox\assemblies_parietal\' rats(rat,:) '\' sprintf('%02.0f',recording)  '\'...
...
%     % HMM, linear regression, GLM  
    ...
    load(['C:\Users\Nitz Lab 2\Dropbox_tingley\Dropbox\recording_trains_pairwise_parietal\' rats(rat,:) '\' sprintf('%02.0f',recording)  '\'...
           rats(rat,:) '_rec_' sprintf('%02.0f',recording) '_winsize_'  num2str(win) '.mat'],...
...
if ~isempty(cell_list)
        ...
        save(['C:\Users\Nitz Lab 2\Dropbox_tingley\Dropbox\assemblies_parietal\' rats(rat,:) '\' sprintf('%02.0f',recording)  '\'...
           rats(rat,:) '_rec_' sprintf('%02.0f',recording) '_winsize_'  num2str(win) '.mat'],...
